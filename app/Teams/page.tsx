      ...
      <div className="bg-white ">
        <div className="mx-auto grid max-w-7xl gap-x-8 gap-y-20 px-6 lg:px-8 xl:grid-cols-3">
          <div className="max-w-2xl">
            <h2 className="text-3xl font-bold tracking-tight text-blue-900 sm:text-4xl">Best Team</h2>
            <p className="mt-6 text-lg leading-8 text-gray-600">
             This is the best son and daughter from this country who is an important part of our corporate team.
            </p>
          </div>
